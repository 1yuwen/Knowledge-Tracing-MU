...
def get_unlearn_dataloader(args):
    ...
    if args.unlearn_dataset == 'Subsetdog':
        ...
        unlearning_goal=args.unlearning_goal
        if args.unlearning_goal=='fine':
            unlearn_trainset = args.unlearn_Dataset.Subsetdog_Unlearn( root='./data/Subsetdog', train=True,unlearn=True,goal=unlearning_goal,unlearn_classes= unlearn_fine_classes)
            unlearn_testset = args.unlearn_Dataset.Subsetdog_Unlearn(root='./data/Subsetdog', train=False,unlearn=True,goal=unlearning_goal,unlearn_classes= unlearn_fine_classes)
        if args.unlearning_goal=='coarse':
            unlearn_trainset = args.unlearn_Dataset.Subsetdog_Unlearn( root='./data/Subsetdog', train=True,unlearn=True,goal=unlearning_goal,unlearn_classes= unlearn_coarse_classes)
            unlearn_testset = args.unlearn_Dataset.Subsetdog_Unlearn(root='./data/Subsetdog', train=False,unlearn=True,goal=unlearning_goal,unlearn_classes= unlearn_coarse_classes)
        if args.unlearning_goal=='hybrid':
            unlearn_coarse_trainset = args.unlearn_Dataset.Subsetdog_Unlearn( root='./data/Subsetdog', train=True,unlearn=True,goal='coarse',unlearn_classes= unlearn_coarse_classes)
            unlearn_coarse_testset = args.unlearn_Dataset.Subsetdog_Unlearn(root='./data/Subsetdog', train=False,unlearn=True,goal='coarse',unlearn_classes= unlearn_coarse_classes)   
            unlearn_fine_trainset = args.unlearn_Dataset.Subsetdog_Unlearn( root='./data/Subsetdog', train=True,unlearn=True,goal='fine',unlearn_classes= unlearn_coarse_classes)
            unlearn_fine_testset = args.unlearn_Dataset.Subsetdog_Unlearn(root='./data/Subsetdog', train=False,unlearn=True,goal='fine',unlearn_classes= unlearn_coarse_classes)     
            unlearn_trainset= ConcatDataset([unlearn_coarse_trainset,unlearn_fine_trainset])  
            unlearn_testset= ConcatDataset([unlearn_coarse_testset,unlearn_fine_testset])
...
def get_retain_dataloader(args):
    ...
    if args.unlearn_dataset == 'Subsetdog':
        if args.unlearning_goal=='fine':
            retain_trainset = args.unlearn_Dataset.Subsetdog_Unlearn( root='./data/Subsetdog', train=True,unlearn=False,goal=unlearning_goal,unlearn_classes= unlearn_fine_classes)
            retain_testset = args.unlearn_Dataset.Subsetdog_Unlearn(root='./data/Subsetdog', train=False,unlearn=False,goal=unlearning_goal,unlearn_classes= unlearn_fine_classes)
        elif args.unlearning_goal=='coarse':
            retain_trainset = args.unlearn_Dataset.Subsetdog_Unlearn( root='./data/Subsetdog', train=True,unlearn=False,goal=unlearning_goal,unlearn_classes= unlearn_coarse_classes)
            retain_testset = args.unlearn_Dataset.Subsetdog_Unlearn(root='./data/Subsetdog', train=False,unlearn=False,goal=unlearning_goal,unlearn_classes= unlearn_coarse_classes)
        elif args.unlearning_goal=='hybrid':
            unlearn_classes=unlearn_fine_classes+unlearn_coarse_classes
            retain_trainset = args.unlearn_Dataset.Subsetdog_Unlearn( root='./data/Subsetdog', train=True,unlearn=False,goal=unlearning_goal,unlearn_classes= unlearn_classes)
            retain_testset = args.unlearn_Dataset.Subsetdog_Unlearn(root='./data/Subsetdog', train=False,unlearn=False,goal=unlearning_goal,unlearn_classes= unlearn_classes)      
